...
The files start.py, main.py, rank.py, selectfirm.py, etc. corresponded to the respective pages, and the financial comments referred to the website [https://github.com/wcfjeffrey/Python](https://caibaoshuo.com/)(财报说). For example, the financial performance of the sample company Ping An Bank is as follows:
