...
The files (start.py, main.py, rank.py, selectfirm.py, etc.) correspond to their respective pages, and the financial commentary was obtained by web crawling the website [caibaoshuo.com](https://caibaoshuo.com/) (财报说). For example, the financial performance of the sample company Ping An Bank is as follows:
